...
|----|---------|--------|-----------|------|------|
| EC-14 | 予約は2週間先から＋2週間以内は問い合わせフォームへ | 中 | IN_PROGRESS | Son | 2026-08-18起票（Keita指示）。公開予約を今日+14日以降の枠に制限（UI＋APIサーバ側enforce）。2週間以内希望者向けの問い合わせフォーム新設（保存+ホスト通知）。adminは制限なし |
